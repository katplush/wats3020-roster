...
class Course {
  ...
  addStudent() {
    let name = prompt('Enter student\'s full name: ','Katterina Plushko');
    let email = prompt ('Enter student email: ','plushkok@seattleu.edu');
  ...
  setTeacher() {
    ...
    let email = prompt('Enter teach email: ','peltzr@seattleu.edu');
...
let courseDescription = prompt('Enter the course descrption: ','Learning to code JS');
